...
# git clone --depth=1 https://github.com/natelol/luci-app-beardropper package/luci-app-beardropper
...
sed -i "s/${orig_version}/R${date_version} by Buzidjy/g" package/lean/default-settings/files/zzz-default-settings
